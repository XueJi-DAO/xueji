...
基于语义计算结合智能助理，通过对话式可视化的方式管理你的数据、迭代你的知识。

All task in one place，Help You Get Things Done!

**专注智能知识管理**: 对话式智能交互 + 知识可视化 + 知识地图 + 记忆宫殿 + 自我管理 GTD => 智能工具 + 学习积累 => 组织协作 DAO

## 设计理念

极致体验: **智能交互 简捷操作 精准内容 高效协作 安全可信**
...
- **一切皆文档**: 基于语义组件, 画板, 插件, 智能模板, **定制**, 按需组合成你需要的应用, 一个地方解决所有问题
- **智能交互**: 命令行+对话式交互, 智能推理推荐, 辅助创作, 引导思考, 提问, 自然交互, 学习增强, 与专属助理一同成长
...
- 专属助理: **学记助理**, 自然语言交互, 能动性, 生成推荐提醒, 数字人
- 知识管理：覆盖收集 整理 理解 应用(检索,问答) 创新(创作) 分享
- 虚拟空间: **记忆宫殿**, 3D 可视化, 软件硬件集成
- 自我管理: 原则目标时间精力数据管理, **GTD**
- 自治组织：实时协作, 任务徽章, 智能合约, 贡献积分, **DAO**
